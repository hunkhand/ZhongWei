...
#define CLR_SCK             GPIO_ResetBits(GPIOB, GPIO_Pin_3);

#define SET_MOSI            GPIO_SetBits(GPIOB, GPIO_Pin_5);
#define CLR_MOSI            GPIO_ResetBits(GPIOB, GPIO_Pin_5);

#define SET_SSN             GPIO_SetBits(GPIOA, GPIO_Pin_15);
#define CLR_SSN             GPIO_ResetBits(GPIOA, GPIO_Pin_15);


#define READ_MISO			GPIO_ReadInputDataBit(GPIOB, GPIO_Pin_4)
